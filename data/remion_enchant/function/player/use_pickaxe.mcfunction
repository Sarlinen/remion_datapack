scoreboard players reset @s remion_enchants.use.wooden_pickaxe
scoreboard players reset @s remion_enchants.use.stone_pickaxe
scoreboard players reset @s remion_enchants.use.golden_pickaxe
scoreboard players reset @s remion_enchants.use.iron_pickaxe
scoreboard players reset @s remion_enchants.use.diamond_pickaxe
scoreboard players reset @s remion_enchants.use.netherite_pickaxe
